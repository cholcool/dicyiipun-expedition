...
function tguy_sm_summary_table_gg($days, $do_include_successes = true) {
    global $wpdb;
    ...
    if (count($results)) {
        ...
        <tbody>
        <tr class="alternate"><th class="sm-text"><?php _e('Word', 'search-meter') ?></th><th><?php _e('Searches', 'search-meter') ?></th>
        <?php
        ...
        foreach ($results as $result) {
            ...
            <td><a href="<?php echo get_bloginfo('wpurl').'/?s='.urlencode($result->terms).'&submit=Search' ?>"><?php echo htmlspecialchars($result->terms) ?></a></td>
