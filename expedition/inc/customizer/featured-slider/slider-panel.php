...
$expedition_panels['expedition-featured-slider'] =
    array(
        'title'          => __( 'Home Page Main Slider', 'expedition' ),
        'priority'       => 150
    );
...
/*slider selection from custom slider main logo image */
require get_template_directory().'/inc/customizer/featured-slider/slider-main-logo.php';