...
if( ! function_exists( 'expedition_simple_breadcrumb' ) ) :
    ...
    function expedition_simple_breadcrumb( $args = array() ){
        ...
        $text['author']   = __( 'View all posts by <em>%s</em>', 'expedition' ); // text for an author page
        $text['404']      = __( 'Error 404', 'expedition' ); // text for the 404 page
        ...
        elseif (is_home()) {
            ...
            echo '<div id="crumbs"><a href="' . esc_url($homeLink) . '">' . $text['home'] .$delimiter. '</a> </div>';
            ...
            if ( get_query_var('paged') ) {
                ...
                echo __( 'Page', 'expedition' ) . ' ' . get_query_var('paged');
                if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo ')';
            }
    ...
    } // end expedition_simple_breadcrumb()
