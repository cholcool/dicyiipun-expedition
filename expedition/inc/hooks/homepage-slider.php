...
if ( ! function_exists( 'expedition_featured_slider_array' ) ) :
    ...
    function expedition_featured_slider_array( $from_slider ){
        ...
        $expedition_feature_slider_contents_array[0]['expedition-feature-slider-image'] = get_template_directory_uri()."";
...
if ( ! function_exists( 'expedition_featured_home_slider' ) ) :
    ...
    function expedition_featured_home_slider() { 
        ...
        $expedition_slide_main_logo_image = $expedition_customizer_all_values['expedition-im-slide-main-logo-image'];
        $expedition_slide_main_logo_image_title = $expedition_customizer_all_values['expedition-im-slide-main-logo-image-title'];
        $expedition_slide_main_logo_image_content = $expedition_customizer_all_values['expedition-im-slide-main-logo-image-content'];
        $expedition_slide_main_logo_image_link = get_site_url().$expedition_customizer_all_values['expedition-im-slide-main-logo-image-link'];
        $expedition_slide_main_logo_image_tagline = $expedition_customizer_all_values['expedition-im-slide-main-logo-image-tagline'];
                ...
                foreach( $expedition_slider_arrays as $expedition_slider_array ){
                    ...
                    <div class="slide-item">
                        <div class="container-full" style="background-image: url('<?php echo esc_url( $expedition_feature_slider_image )?>');">
                            <div class="row">
                                <div class="column-xsd-12 column-sd-10 column-md-6 column-sd-offset-1 column-md-offset-3 banner-content">
                                    <?php if ((1 == $expedition_feature_enable_title) || (1 == $expedition_feature_enable_caption)){?>
                                        <div class="banner-content-holder">
                                            <a href="<?php echo esc_url( $expedition_slide_main_logo_image_link );?>"><img src="<?php echo esc_url($expedition_slide_main_logo_image); ?>" alt="<?php echo esc_html ($expedition_slide_main_logo_image_tagline); ?>"  title="<?php echo esc_html ($expedition_slide_main_logo_image_tagline); ?>"></a>
                                            <div class="banner-content-inner">
                                                <?php if( 1 == $expedition_feature_enable_title) {
                                                    ?>
                                                        <h2 class="slider-title">
                                                        <a href="<?php echo esc_url( $expedition_slide_main_logo_image_link );?>"><?php echo __( $expedition_slide_main_logo_image_title );?></a></h2>
                                                    <?php
                                                }
                                                if( 1 == $expedition_feature_enable_caption){
                                                    ?>
                                                    <div class="text-content">
                                                        <?php echo ( $expedition_slide_main_logo_image_content );?>
                                                    </div>
                                                    <?php
                                                }?>      
                                            </div>
        ...
        <section class="wrapper wrap-search">
            <div class="container">
                        ...
                        <div class="search-section">
                            <form role="search" method="post" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                <div class="search-input-holder">
                                    ...
                                    <input class="search-field" type="text" placeholder="search for global & hit enter..." value="<?php if (!empty(the_search_query())) {header("Location: $_SERVER[PHP_SELF]");} ?>" name="s" id="s" />
                ...
                <div class="row">
                    ...
                    <div class="column-md-4">
                        <h3>Top 10 of last <span style="color: #008cdd">7 days</span></h3>
                        <?php _e(tguy_sm_summary_table_gg(7)); ?>
                    </div>
                    <div class="column-md-4">
                        <h3>Top 10 of last <span style="color: #008cdd">30 days</span></h3>
                        <?php _e(tguy_sm_summary_table_gg(30)); ?>
                    </div>
                </div>
            </div>
        </section>
        <?php dynamic_sidebar( 'credit-by' ); ?>
        <section class="wrapper wrap-footer">
            <?php do_action( 'expedition_action_footer' ); ?>
        </section>
</div>
    <?php }  ?>
