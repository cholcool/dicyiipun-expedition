    ...
    ?>
        <header id="masthead" class="wrapper site-header" role="banner">
            <div class="thumb-overlay-top">
                <div class="container ">
                    <div class="row">
                        <div class="column-ld-push-07 column-md-2 column-sd-12 column-xsd-12 rtl-fright">
                        ...
                        <div class="column-ld-push-05 column-md-8 column-sd-9 column-xsd-12 rtl-fleft">
                            <section class="wrapper wrap-search head-search">
                                <div class="container">
                                    <div class="row">
                                        <div class="">
                                            <div class="search-section">
                                                <form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                                    <div class="search-input-holder">
                                                        ...
                                                        <input class="search-field" type="text" placeholder="ค้นหาคําศัพท์หรือคำแปลภาษาญี่ปุ่น⇔ภาษาไทยภายในเว็บไซต์ DICYIIPUN.COM" value="<?php echo get_search_query(); ?>" name="s" id="s" onblur="checkLeter();" />
                        ...
                        <div class="column-ld-push-02 column-md-2 column-sd-3 column-xsd-12 rtl-fleft">
                            <section class="wrapper wrap-search head-search">
                                <div class="container">
                                    <div class="row">
 ...
 */
    function expedition_add_breadcrumb(){
        ...
        echo '<div id="breadcrumb" class="wrapper wrap-breadcrumb csv-search"><div class="container">';
